...
use iRESTful\LeoPaul\Applications\Libraries\PDOEntities\Infrastructure\Services\PDOEntitySetService;
...
final class PDOEntitySetServiceTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        ...
        $this->service = new PDOEntitySetService($this->requestEntityAdapterMock, $this->pdoServiceMock);
    ...
    public function testInsert_Success() {
        ...
        $this->requestEntityAdapterHelper->expectsFromEntitiesToInsertRequests_Success([$this->insertRequest], [$this->simpleEntityMock]);
    ...
    public function testInsert_throwsPDOException_throwsEntitySetException() {
    ...
    public function testInsert_throwsRequestEntityException_throwsEntitySetException() {

        $this->requestEntityAdapterHelper->expectsFromEntitiesToInsertRequests_throwsRequestEntityException([$this->simpleEntityMock]);
    ...
    public function testUpdate_Success() {
        ...
        $this->requestEntityAdapterHelper->expectsFromEntitiesToUpdateRequests_Success([$this->updateRequest], [$this->simpleEntityMock], [$this->simpleEntityMock]);
    ...
    public function testUpdate_throwsPDOException_throwsEntitySetException() {
    ...
    public function testUpdate_throwsRequestEntityException_throwsEntitySetException() {

        $this->requestEntityAdapterHelper->expectsFromEntitiesToUpdateRequests_throwsRequestEntityException([$this->simpleEntityMock], [$this->simpleEntityMock]);
    ...
    public function testDelete_Success() {
        ...
        $this->requestEntityAdapterHelper->expectsFromEntitiesToDeleteRequests_Success([$this->deleteRequest], [$this->simpleEntityMock]);
    ...
    public function testDelete_throwsPDOException_throwsEntitySetException() {
    ...
    public function testDelete_throwsRequestEntityException_throwsEntitySetException() {

        $this->requestEntityAdapterHelper->expectsFromEntitiesToDeleteRequests_throwsRequestEntityException([$this->simpleEntityMock]);
