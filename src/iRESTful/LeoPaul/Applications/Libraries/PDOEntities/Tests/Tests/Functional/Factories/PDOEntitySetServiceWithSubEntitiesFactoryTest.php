...
final class PDOEntitySetServiceWithSubEntitiesFactoryTest extends \PHPUnit_Framework_TestCase {
    private $factory;
    ...
    public function setUp() {
        ...
        $this->factory = new PDOEntitySetServiceWithSubEntitiesFactory($transformerObjects, $containerClassMapper, $interfaceClassMapper, $delimiter, $timezone, $driver, $hostname, $database, $username, $password);
        $this->factoryWithInvalidPassword = new PDOEntitySetServiceWithSubEntitiesFactory($transformerObjects, $containerClassMapper, $interfaceClassMapper, $delimiter, $timezone, $driver, $hostname, $database, $username, 'invalid password');
    }
