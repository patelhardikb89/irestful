...
final class PDOEntityServiceWithSubEntitiesFactoryTest extends \PHPUnit_Framework_TestCase {
    private $factory;
    ...
    public function setUp() {
        ...
        $this->factory = new PDOEntityServiceWithSubEntitiesFactory($transformerObjects, $containerClassMapper, $interfaceClassMapper, $delimiter, $timezone, $driver, $hostname, $database, $username, $password);
        $this->factoryWithInvalidPassword = new PDOEntityServiceWithSubEntitiesFactory($transformerObjects, $containerClassMapper, $interfaceClassMapper, $delimiter, $timezone, $driver, $hostname, $database, $username, 'invalid password');
    }
