...
final class PDOEntitySetServiceWithSubEntitiesFactory implements EntitySetServiceFactory {
    ...
    public function create() {
        ...
        try {
            ...
            return new PDOEntitySetService($requestEntityWithSubEntitiesAdapter, $pdoService);

        } catch (PDOException $exception) {
            throw new EntitySetException('There was an exception while converting data to a PDOService object.', $exception);
