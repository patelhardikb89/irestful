...
final class PDORetrieveRelationFactory implements ControllerFactory {
    private $adapter;
    ...
    public function create() {
        ...
        $repositoryFactory = $this->adapter->fromClassNameToObject('iRESTful\LeoPaul\Applications\Libraries\PDOEntities\Infrastructure\Factories\PDOEntityRelationRepositoryFactory');
        ...
        return new RetrieveRelation($responseAdapter, $repositoryFactory, $adapterFactory);
