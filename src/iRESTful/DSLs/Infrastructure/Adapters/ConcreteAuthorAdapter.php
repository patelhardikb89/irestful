...
use iRESTful\DSLs\Domain\Authors\Adapters\AuthorAdapter;
use iRESTful\DSLs\Domain\Authors\Exceptions\AuthorException;
use iRESTful\DSLs\Domain\Authors\Emails\Adapters\EmailAdapter;
use iRESTful\DSLs\Domain\URLs\Adapters\UrlAdapter;
use iRESTful\DSLs\Infrastructure\Objects\ConcreteAuthor;
