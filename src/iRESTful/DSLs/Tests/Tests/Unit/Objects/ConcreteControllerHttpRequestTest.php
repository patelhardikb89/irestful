...
final class ConcreteControllerHttpRequestTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->commandMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Controllers\HttpRequests\Commands\Command');
        $this->viewMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Controllers\HttpRequests\Views\View');
        $this->valueMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Values\Value');
