...
final class ConcreteObjectTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->propertyMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Objects\Properties\Property');
        $this->databaseMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Databases\Database');
        $this->methodMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Objects\Methods\Method');
        $this->sampleMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Objects\Samples\Sample');
