...
final class ConcreteProjectTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->dslMock = $this->createMock('iRESTful\DSLs\Domain\DSL');
        $this->objectMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Objects\Object');
        $this->controllerMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Controllers\Controller');
