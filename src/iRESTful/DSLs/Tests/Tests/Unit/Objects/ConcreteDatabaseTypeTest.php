...
final class ConcreteDatabaseTypeTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->binaryMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Types\Databases\Binaries\BinaryType');
        $this->floatMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Types\Databases\Floats\FloatType');
        $this->integerMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Types\Databases\Integers\IntegerType');
        $this->stringMock = $this->createMock('iRESTful\DSLs\Domain\Projects\Types\Databases\Strings\StringType');
    }
