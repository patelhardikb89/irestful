...
final class ConcreteApi extends AbstractEntity implements Api {
    ...
    /**
    *   @baseUrl -> getBaseUrl()->get() -> base_url ## @string max -> 255 ** iRESTful\Authenticated\Domain\Types\BaseUrls\Adapters\BaseUrlAdapter::fromStringToBaseUrl  
    *   @endpoints -> getEndpoints() -> endpoints ## @binary specific -> 128 ** @elements-type -> iRESTful\Authenticated\Domain\Entities\Endpoint 
    */
