...
final class RetrievePartialSetTest extends \PHPUnit_Framework_TestCase {
                ...
                function() {
                    $retrieveSetData = function($container, array $data, $index, $amount) {
                        $entitySet = $this->entityPartialSetFactory->create()->retrieve([
                            ...
                            'index' => ,
                            'amount' => isset($input["data|length"]) ? $input["data|length"] : null,
                        ]);
                        
                        $data = $this->entityAdapterFactory->create()->fromEntityPartialSetToData($entitySet);
