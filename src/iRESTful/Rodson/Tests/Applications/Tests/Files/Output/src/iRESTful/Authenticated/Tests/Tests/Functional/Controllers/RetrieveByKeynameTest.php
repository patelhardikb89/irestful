...
final class RetrieveByKeynameTest extends \PHPUnit_Framework_TestCase {
                ...
                function() {
                    $retrieveData = function($containerName, array $data) {
                        $entity = $this->entityRepositoryFactory->create()->retrieve([
                            ...
                            'keyname' => [
                                'name' => isset($input["data|property->name"]) ? $input["data|property->name"] : null
                                'value' => isset($input["data|property->value"]) ? $input["data|property->value"] : null
                            ]
                        ]);
                        
                        $data = $this->entityAdapterFactory->create()->fromEntityToData($entity);
