...
final class AuthenticatedConfiguration implements EntityConfiguration {
    ...
    public function getContainerClassMapper() {
        return [
            'endpoint' => 'iRESTful\Authenticated\Infrastructure\Entities\ConcreteEndpoint',
    ...
    public function getInterfaceClassMapper() {
        return [
            'iRESTful\Authenticated\Domain\Entities\Endpoint' => 'iRESTful\Authenticated\Infrastructure\Entities\ConcreteEndpoint',
    ...
    public function getTransformerObjects() {
        return [
            ...
            'iRESTful\Objects\Libraries\Dates\Domain\Adapters\DateTimeAdapter' => new \iRESTful\Objects\Libraries\Dates\Infrastructure\Adapters\ConcreteDateTimeAdapter($this->getTimezone()),
