...
final class ConcreteDatabaseAdapterTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->relationalDatabaseAdapterMock = $this->getMock('iRESTful\Rodson\Domain\Databases\Relationals\Adapters\RelationalDatabaseAdapter');
        $this->relationalDatabaseMock = $this->getMock('iRESTful\Rodson\Domain\Databases\Relationals\RelationalDatabase');
        $this->restAPIAdapterMock = $this->getMock('iRESTful\Rodson\Domain\Databases\RESTAPIs\Adapters\RESTAPIAdapter');
