...
use iRESTful\Rodson\Infrastructure\Adapters\ConcreteInterfaceMethodAdapter;
...
final class ConcreteInterfaceMethodAdapterTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->returnedInterfaceAdapterMock = $this->getMock('iRESTful\Rodson\Domain\Outputs\Interfaces\Methods\Returns\Adapters\ReturnedInterfaceAdapter');
        $this->returnedInterfaceMock = $this->getMock('iRESTful\Rodson\Domain\Outputs\Interfaces\Methods\Returns\ReturnedInterface');
        $this->parameterAdapterMock = $this->getMock('iRESTful\Rodson\Domain\Outputs\Interfaces\Methods\Parameters\Adapters\ParameterAdapter');
        ...
        $this->adapter = new ConcreteInterfaceMethodAdapter($this->returnedInterfaceAdapterMock, $this->parameterAdapterMock);
    ...
    public function testFromTypeToMethods_withDatabaseAdapter_withFromType_Success() {
        ...
        $this->assertEquals('fromFromTypeToMainType', $methods['database']->getName());
        $this->assertTrue($methods['database']->hasReturnedType());
        $this->assertEquals($this->returnedInterfaceMock, $methods['database']->getReturnedType());
        $this->assertTrue($methods['database']->hasParameters());
        $this->assertEquals([$this->parameterMock], $methods['database']->getParameters());
        $this->assertFalse(isset($methods['view']));
    ...
    public function testFromTypeToMethods_withDatabaseAdapter_withFromType_withToType_Success() {
        ...
        $this->assertEquals('fromFromTypeToToType', $methods['database']->getName());
        $this->assertTrue($methods['database']->hasReturnedType());
        $this->assertEquals($this->returnedInterfaceMock, $methods['database']->getReturnedType());
        $this->assertTrue($methods['database']->hasParameters());
        $this->assertEquals([$this->parameterMock], $methods['database']->getParameters());
    ...
    public function testFromTypeToMethods_withDatabaseAdapter_withToType_Success() {
        ...
        $this->assertEquals('fromMainTypeToToType', $methods['database']->getName());
        $this->assertTrue($methods['database']->hasReturnedType());
        $this->assertEquals($this->returnedInterfaceMock, $methods['database']->getReturnedType());
        $this->assertTrue($methods['database']->hasParameters());
        $this->assertEquals([$this->parameterMock], $methods['database']->getParameters());
    ...
    public function testFromTypeToMethods_withViewAdapter_withFromType_withToType_Success() {
        ...
        $this->assertEquals('fromFromTypeToToType', $methods['view']->getName());
        $this->assertTrue($methods['view']->hasReturnedType());
        $this->assertEquals($this->returnedInterfaceMock, $methods['view']->getReturnedType());
        $this->assertTrue($methods['view']->hasParameters());
        $this->assertEquals([$this->parameterMock], $methods['view']->getParameters());
        $this->assertFalse(isset($methods['database']));
