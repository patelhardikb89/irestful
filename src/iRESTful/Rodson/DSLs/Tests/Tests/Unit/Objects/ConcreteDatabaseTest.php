...
final class ConcreteDatabaseTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->relationalDatabaseMock = $this->createMock('iRESTful\Rodson\DSLs\Domain\Projects\Databases\Relationals\RelationalDatabase');
        $this->restAPIMock = $this->createMock('iRESTful\Rodson\DSLs\Domain\Projects\Databases\RESTAPIs\RESTAPI');
