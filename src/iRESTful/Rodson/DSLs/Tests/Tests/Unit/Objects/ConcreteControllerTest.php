...
final class ConcreteControllerTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->viewMock = $this->createMock('iRESTful\Rodson\DSLs\Domain\Projects\Controllers\Views\View');
        $this->httpRequestMock = $this->createMock('iRESTful\Rodson\DSLs\Domain\Projects\Controllers\HttpRequests\HttpRequest');
