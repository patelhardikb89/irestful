...
use iRESTful\Rodson\DSLs\Tests\Helpers\Objects\CodeHelper;
...
final class ConcreteCodeMethodTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->codeMock = $this->createMock('iRESTful\Rodson\DSLs\Domain\Projects\Codes\Code');

        $this->className = 'iRESTful\Rodson\DSLs\Tests\Tests\Unit\Objects\ConcreteCodeMethodTest';
