...
final class ConcreteTypeTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->databaseTypeMock = $this->createMock('iRESTful\Rodson\DSLs\Domain\Projects\Types\Databases\DatabaseType');
        $this->converterMock = $this->createMock('iRESTful\Rodson\DSLs\Domain\Projects\Converters\Converter');
