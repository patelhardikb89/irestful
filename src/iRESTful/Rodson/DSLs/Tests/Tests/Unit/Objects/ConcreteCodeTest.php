...
final class ConcreteCodeTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->languageMock = $this->createMock('iRESTful\Rodson\DSLs\Domain\Projects\Codes\Languages\Language');

        $this->className = 'iRESTful\Rodson\DSLs\Tests\Tests\Unit\Objects\ConcreteCodeTest';
    }
